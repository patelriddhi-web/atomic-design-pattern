    ...
    <div className="sub-header">
      ...
      <div className="btn-header-wrapper">
        <Button className="btn">
          <span>Kindle e-Readers</span>
        </Button>
        <Button className="btn">
          <span>Free Kindle Reading Apps</span>
        </Button>
        <Button className="btn">
        ...
        <Button className="btn">
          <span>Deals on Kindle eBooks</span>
        </Button>
        <Button className="btn">
          <span>Best Sellers</span>
        </Button>
        <Button className="btn">
          <span>Indian language eBooks</span>
        </Button>
        <Button className="btn">
          <span>Kindle Exam Central</span>
        </Button>
        <Button className="btn">
          <span>Kindle eTextbooks</span>
        </Button>
      </div>
    </div>
  )
